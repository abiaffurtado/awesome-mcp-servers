...
- - **[LigueLead](https://github.com/liguelead/mcp)** - Send SMS, SMS Flash, and voice calls in Brazil via [LigueLead](https://liguelead.com.br) API. Brazilian CPaaS with BRL pricing and PIX payments.
